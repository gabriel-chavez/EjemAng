...
@Component({
  ...
  selector: '[app-favorite-row-list-details-providers-payment]',
  templateUrl: './favorite-row-list-details-providers-payment.component.html',
  styleUrls: ['./favorite-row-list-details-providers-payment.component.css']
})
export class FavoriteRowListDetailsProvidersPaymentComponent implements OnInit {

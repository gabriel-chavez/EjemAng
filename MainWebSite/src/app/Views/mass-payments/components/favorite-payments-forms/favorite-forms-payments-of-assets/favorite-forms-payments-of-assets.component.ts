...
@Component({
  selector: 'app-favorite-forms-payments-of-assets',
  templateUrl: './favorite-forms-payments-of-assets.component.html',
  styleUrls: ['./favorite-forms-payments-of-assets.component.css'],
  providers: [FavoritePaymentsService, UtilsService]
})
export class FavoriteFormsPaymentsOfAssetsComponent implements OnInit {

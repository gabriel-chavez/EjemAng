...
@Component({
  selector: 'app-a-month-ago',
  templateUrl: './a-month-ago.component.html',
  styleUrls: ['./a-month-ago.component.css'],
  providers: [VoucherOperationService]
})
export class AMonthAgoComponent implements OnInit {

...
@Component({
  selector: 'app-two-months-ago',
  templateUrl: './two-months-ago.component.html',
  styleUrls: ['./two-months-ago.component.css'],
  providers: [VoucherOperationService, UserService]
})
export class TwoMonthsAgoComponent implements OnInit {

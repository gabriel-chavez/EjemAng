...
@Component({
  selector: 'app-three-months-ago',
  templateUrl: './three-months-ago.component.html',
  styleUrls: ['./three-months-ago.component.css'],
  providers: [VoucherOperationService, UserService]
})
export class ThreeMonthsAgoComponent implements OnInit {

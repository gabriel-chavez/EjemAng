...
@Directive({
    selector: '[appOnlyAlphanumericNotSymbols]'
})

export class OnlyAlphanumericNotSymbolsDirective {
    private regex: RegExp = new RegExp(ValidateConst.find(x => x.type === 'alphanumericNotSymbols').regex);
